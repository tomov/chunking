...
%planning i hard
%you should have chunks
%what should chunks be?
%previous approaches -- powerful but broad; weak -- no free lunch theorem 
%    very weak assumptions about kinds of graphs 
%    solway, no assumptions about distribution of graphs
%
%big picture: using structure of env't to constrain inferences about chunks; so you have chunks tailored to kinds of tasks you're doing
%
%the chunks should generalize across some distribution; Solway : things that generalize across all tasks for fixed graph; We: distribution of graphs, but also distribution of tasks that might be lower entropy than the uniform distribution in Solway -> you're more specificaly attuned to task distribution
%
%however their approach makes strong assumptions about the distribution of 
%
%people can have stronger inductive biases 
%can learn distribution
%
%Furthermore, their approach does not accommodate different task distributions or reward structures. 
%
%story: planning is hard; structural constraints to figure out chunks; purely graph structure constraints (when task distr is uniform, plausible in exp'ts done previously); but in addition, model gives us opportunity to consider non-uniform task distrubitons
%
%optimal hierarchy depends on structure of environment, not just graph structure (transition) but also probability distribution of tasks you have to do in that enrivonment, as well as distribution of rewards.
